...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchAll = useCallback(async () => {
    ...
    if (sessionsRes.data) setSessions(sessionsRes.data.map(s => ({
      ...
      attendance_code_status: s.attendance_code_status as Session['attendance_code_status'],
      ...
      status: s.status as Session['status'], attendance_rate: s.attendance_rate,
    })));
    ...
    if (recordsRes.data) setRecords(recordsRes.data.map(r => ({
      ...
      checked_in_at: r.checked_in_at, check_in_method: r.check_in_method as AttendanceRecord['check_in_method'],
